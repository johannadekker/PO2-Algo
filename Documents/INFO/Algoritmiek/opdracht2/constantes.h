...
const int MaxNrSpelers = 20;
const int MaxGrootteSchema = 390; // (MaxNrSpelers-1) rondes met elk
                                  // MaxNrSpelers plekken voor spelers

        

// TODO: zo nodig uw eigen constantes
